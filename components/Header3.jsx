  ...
  return (
    <div className='bg-gradient-to-r from-red-600 to-red-400 h-60'>
     ...
     <div className="grid grid-cols-5 my-5 mx-20">
      ...
      <input type='text' placeholder='Search..' className='h-16 outline-none px-3 text-lg border-r-2 border-gray-400 col-span1'/>
...
<button type='submit' className='h-16 px-3 py-2 border-2 border-white hover:cursor-pointer text-white  mr-5 hover:bg-slate-100'>
